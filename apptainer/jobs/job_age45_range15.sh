...
#SBATCH --job-name=mimic-age45-r15
#SBATCH --mem=100G
#SBATCH --cpus-per-task=8
#SBATCH --time=96:00:00
#SBATCH --output=mimic_age45_range15_%j.log

# Scenario: age45_range15 (ages 38-52)
# Output: data/curated/age45_range15/
...
export MIMIC_EXTRACT_OUTPUT_DIR="/opt/mimic-extract/data/curated/age45_range15"
export POP_SIZE=0
