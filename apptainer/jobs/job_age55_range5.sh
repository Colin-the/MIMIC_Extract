...
#SBATCH --job-name=mimic-age55-r5
#SBATCH --mem=100G
#SBATCH --cpus-per-task=8
#SBATCH --time=96:00:00
#SBATCH --output=mimic_age55_range5_%j.log

# Scenario: age55_range5 (ages 53-57)
# Output: data/curated/age55_range5/
...
export MIMIC_EXTRACT_OUTPUT_DIR="/opt/mimic-extract/data/curated/age55_range5"
export POP_SIZE=0
