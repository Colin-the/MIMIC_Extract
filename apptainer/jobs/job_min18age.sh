...
#SBATCH --job-name=mimic-min18age
#SBATCH --mem=100G
#SBATCH --cpus-per-task=8
#SBATCH --time=96:00:00
#SBATCH --output=mimic_min18age_%j.log

# Scenario: min18age (adults only, ≥18 years)
# Output: data/curated/min18age/
...
export MIMIC_EXTRACT_OUTPUT_DIR="/opt/mimic-extract/data/curated/min18age"
export POP_SIZE=0
