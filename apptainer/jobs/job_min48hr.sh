...
#SBATCH --job-name=mimic-min48hr
#SBATCH --mem=128G
#SBATCH --cpus-per-task=8
#SBATCH --time=96:00:00
#SBATCH --output=mimic_min48hr_%j.log

# Scenario: min48hr (long stays only, ≥48 hours)
# Output: data/curated/min48hr/
...
export MIMIC_EXTRACT_OUTPUT_DIR="/opt/mimic-extract/data/curated/min48hr"
export POP_SIZE=0
export NUMERICS_BATCH_SIZE=2500
export MIN_AGE=15
export MAX_AGE=999
export MIN_DURATION=48
