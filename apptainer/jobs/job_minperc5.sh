...
#SBATCH --job-name=mimic-minperc5
#SBATCH --mem=100G
#SBATCH --cpus-per-task=8
#SBATCH --time=96:00:00
#SBATCH --output=mimic_minperc5_%j.log

# Scenario: minperc5 (stricter missingness, drop cols >95% missing)
# Output: data/curated/minperc5/
...
export MIMIC_EXTRACT_OUTPUT_DIR="/opt/mimic-extract/data/curated/minperc5"
export POP_SIZE=0
